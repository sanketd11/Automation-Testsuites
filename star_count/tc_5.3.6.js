    /*
     Author: Arko
     Description:    This is a casperjs automated test script for showing that If a notebook is added in the list of 'All Notebooks' and its respective star
     is selected and count=1, then unstaring that notebook should remove it from the 'Notebooks I Starred' list and unstar it in "People I Starred" list
