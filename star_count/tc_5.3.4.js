    /*
     Author: Arko
     Description:    This is a casperjs automated test script for showing that If a notebook is added in the list of 'All Notebooks' and its respective star is not selected and count=0,
     then that notebook is not added to the 'Notebooks I Starred' list. It will be present in "People I Starred" in unstarred state
