    /*
     Author: Arko
     Description:   If the loaded notebook is added in the 'Notebooks I Starred' list,
     then the star present on the top-left corner of the page is selected and count=1
     */
