    ...
    casper.test.begin("  Both Lowercase and Uppercase letters -Ex: rnORm", 5, function suite(test) {
        ...
        casper.then(function () {
            ...
            if (counter >0)
            {
                this.test.pass("search feature is working for both the upper case and lower case letters");
            }
            else
            {
                this.test.fail("search feature is not working for both the upper case and lower case letters");
            }
        });
