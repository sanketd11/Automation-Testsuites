    ...
    casper.test.begin(" Edit a cell from a notebook", 7, function suite(test) {
        ...
        var item2 = "'Manchester'";//item to be searched
        ...
        functions.addcontentstocell(casper, item1); //Source: basicfunctions.js

        casper.viewport(1024, 768).then(function () {
            // functions.search(casper, item1, combo); //Source: basicfunctions.js
