    /*
     Author: Prateek
     Description:    This is a casperjs automated test script for showning that When a cell from a notebook is deleted from Rcloud, the respective content should be deleted from Search Results
     */
