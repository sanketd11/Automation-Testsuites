    ...
    */
    ...
    casper.test.begin(" Text searched is highligted in the text area when searched in double quotes", 5, function suite(test) {
        ...
        var item = '"BadThingsDoHappenToGoodPeople"';
        ...
        //verify that the searched item is found in the local user's div
                ...
                for (var i = 1; i <= counter; i++) {
                    ...
                    if (result == combo) {
                        ...
                        this.test.assertEquals(temp, item, 'Searched item with the double quotes is highlihted ');
                        break;
                    }// if closes
                }//for closes
            });//function closes
