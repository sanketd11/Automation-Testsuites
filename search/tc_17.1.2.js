    ...
    casper.test.begin(" Uppercase Letters -Ex: RNORM, FUNCTION, PRINT", 5, function suite(test) {
        ...
        var item = '"FUNCTIONSTOBESEARCHEDHERE"';//item to be searched
        ...
        casper.viewport(1366, 768).then(function () {
            ...
            this.echo("executed contents of the cell");
            this.wait(6000);
        });
        ...
        casper.then(function(){
            if (this.visible('#input-text-search')) {
                ...
                if (counter >0)
                {
                    this.test.pass("search feature is working for upper case letters");
                }
                else
                    {
                        this.test.fail("search feature is not working for upper case letters");
                    }
            });
