...
//login to att Research,Github and RCloud
exports.login = function (casper, research_username, research_password, github_username, github_password, rcloud_url) {
    return casper
        .then(function () {
            if (casper.getTitle().match(/rcloud.research.att.com/)) {
                casper.viewport(1024, 768).then(function () {
                    this.test.assertTitleMatch(/rcloud.research.att.com/, "RCloud research login page has been loaded");
                    console.log("Login into RCloud research with supplied username and password");
                    this.sendKeys('#login > form:nth-child(1) > table:nth-child(2) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2) > input:nth-child(1)', research_username);
